...
class Settings(BaseSettings):
    ...
    DEBUG: bool = False
    # Use env SECRET_KEY when provided; otherwise fall back to a strong default (matches docker-compose default)
    SECRET_KEY: str = os.getenv(
        "SECRET_KEY",
        "09cd570d76255f488028b1ef90e703d076cdfd0bfd1b2fafdb8d6f00e7eef841",
    )
    ALGORITHM: str = "HS256"
